          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              ...
              className={buttonVariants({
                ...
                size: 'default',
                className:
                  'bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 border-none font-semibold shadow-lg shadow-indigo-500/25 flex items-center gap-2 hover:scale-[1.02] transition-transform duration-200',
              })}
            >
