        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          <Card className="border-slate-800/80 bg-slate-900/40">
            ...
            <CardContent className="p-4 pt-0 space-y-3">
              <div className="flex justify-between text-xs text-slate-400">
                <span>
                  Completed: {completedPanelCount} / {project.panelCount} Panels
                </span>
          ...
          <Card className="border-slate-800/80 bg-slate-900/40">
            ...
            <CardContent className="p-4 space-y-4 divide-y divide-slate-800/40">
              ...
              project.characterBible.characters.length === 0 ? (
            ...
            <Card className="border-amber-500/50 bg-amber-950/10 shadow-lg shadow-amber-500/5 overflow-hidden">
              ...
              <CardHeader className="p-5">
                ...
                <CardDescription className="text-slate-300 mt-1">
                  AI generated the panel description and layout. Please approve
                  the panel below, or reject it with feedback to trigger a
                  recreation.
                </CardDescription>
              </CardHeader>
